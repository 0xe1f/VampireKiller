...
;  are `segments/*.inc` (actors, items, weapon, sfx, poses, scenery, event, state, dir, ram).
...
; CE00 evt_*, C000 main_*, C420 act_*, C41B dir_*.
    ...
    INCLUDE "segments/event.inc"
    INCLUDE "segments/state.inc"
    INCLUDE "segments/dir.inc"
