...
tileset; s18 split a/b files share one PNG). Playfield files
...
- `gfx/metatiles/<stem>.png` - 4x4 metatile-def sheets
...
- `metatiles/<stem>.png` - one sheet per 4×4 metatile-def table
  ...
  not the title-tiles tail of s18's 0xBF blit. Room streams stay on
  `stage_sNN.png`.
