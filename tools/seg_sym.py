...
Usage:
  tools/seg_sym.py 2                 # write generated/seg02.z80dasm.sym
  tools/seg_sym.py --audit           # print cross-bank collisions
"""
...
def emit_segment(seg: int) -> str:
    ...
    lines = [
        ...
        f"; Generated by tools/seg_sym.py — do not edit. BIOS + out-of-window",
...
def audit() -> str:
    ...
    out.append("")
    out.append("regen-seg.sh now filters msx.sym per bank (tools/seg_sym.py), so")
